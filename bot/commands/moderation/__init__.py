...
from bot.commands.descriptions import (ban_cmd, MODER_PREFIX, nostickers_cmd, novideo_cmd,
                                       novoice_cmd, ro_cmd, rr_cmd, stickerson_cmd, videoon_cmd,
                                       voiceon_cmd, unmute_cmd)
...
from .handlers import (ban_command, ban_sender_chat_command, check_user_permissions,
                       check_sticker, check_video, check_voice, nostickers_command,
